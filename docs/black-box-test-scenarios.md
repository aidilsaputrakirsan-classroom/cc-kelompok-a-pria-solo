...
**Catatan implementasi:** unggahan dan `POST /information-extraction` menerima **\textit{file} \textit{PDF}** (bukan gambar mentah). Skenario “bukan gambar” menguji penolakan tipe *file* yang tidak diizinkan.
...
| **D. Status Tiket (Frontend ↔ Backend)** |
...
| **Gagal** | Perilaku menyimpang; lihat log *script* |
